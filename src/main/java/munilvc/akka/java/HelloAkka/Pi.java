package munilvc.akka.java.HelloAkka;
...
public class Pi {
  ...
  public static class Master extends UntypedActor {
    ...
    public Master(final int nrOfWorkers, int nrOfMessages, int nrOfElements, ActorRef listener) {
      ...
      workerRouter = this.getContext().actorOf(
          new Props(Worker.class).withRouter(new RoundRobinRouter(nrOfWorkers)), "workerRouter");
    }
  ...
  public void calculate(final int nrOfWorkers, final int nrOfElements, final int nrOfMessages) {
    ...
    // create the result listener, which will print the result and shutdown the
    // system
